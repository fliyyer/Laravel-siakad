...
<aside class="main-sidebar sidebar-light-primary elevation-4">
    ...
    <a href="" class="brand-link" style="">
        <img src="{{ asset('img/logo.png') }}" alt="SMPN 1 Kedungjati" class="brand-image img-circle elevation-3">
        <span class="brand-text font-weight-bold">SMPN 1 Kedungjati</span>
    </a>
